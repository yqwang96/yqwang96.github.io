...
+ 文中对比了个体策略和整合策略下两种情况的市场表现，用于表明整合策略能够进一步提升市场效益；
+ 文中还对比了其他四种场景的情况，并对结果进行了一些讨论。
...
## 7. 个人觉得未来的研究
- 目前的研究中虽然考虑了乘客的个人倾向，但是实际上这些参数也是作者直接给定的，这部分可能在未来可以进一步改进；
- 另外，可以进一步从问题的复杂性本身考虑，比如有其他研究考虑多目标的派单和车辆的临时租赁。
